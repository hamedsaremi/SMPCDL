...
$(function() {
  ...
  function set_settings() {
    ...
    settings.condition_0_likes = [9999900,9999999];
    ...
    // In condition 2, user will receive 2 likes at the following timepoints (in ms). Default: [10000, 15000,35000,80000,1320000,150000]
    settings.condition_2_likes = [10000,15000];

    // In condition 3, user will receive 3 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_3_likes = [10000,15000,35000];

    // In condition 4, user will receive 4 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_4_likes = [10000,11000,15000,35000];

    // In condition 5, user will receive 5 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_5_likes = [10000,11000,15000,35000,80000];

    // In condition 6, user will receive 6 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_6_likes = [10000,11000,15000,35000,80000,100000];

    // In condition 7, user will receive 7 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_7_likes = [10000,11000,15000,35000,80000,100000,110000];

    // In condition 8, user will receive 8 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_8_likes = [10000,11000,15000,35000,80000,100000,110000,120000];

    // In condition 9, user will receive 9 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_9_likes = [10000,11000,15000,35000,80000,100000,110000,120000,130000];

    // In condition 10, user will receive 10 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_10_likes = [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000];

    // In condition 11, user will receive 11 likes at the following timepoints (in ms). Default: [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]
    settings.condition_11_likes = [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000];
  ...
  settings.condition_0_adjusted_likes = [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000,160000]; //11
  settings.condition_1_adjusted_likes = [10000,11000,15000,35000,80000,100000,110000,120000,130000,140000]; // 10
	settings.condition_2_adjusted_likes = [10000,11000,15000,35000,80000,100000,110000,120000,130000]; // 9
	settings.condition_3_adjusted_likes = [10000,11000,15000,35000,80000,100000,110000,120000]; //8
  settings.condition_4_adjusted_likes = [10000,11000,15000,35000,80000,100000,110000]; //7
  settings.condition_5_adjusted_likes = [10000,11000,15000,35000,80000,100000]; //6
  settings.condition_6_adjusted_likes = [10000,11000,15000,35000,80000]; //5
  settings.condition_7_adjusted_likes = [10000,11000,15000,35000]; //4
  settings.condition_8_adjusted_likes = [10000,15000,35000]; //3
  settings.condition_9_adjusted_likes = [10000,15000]; //2
  settings.condition_10_adjusted_likes = [12000, 9999999]; //1
  settings.condition_11_adjusted_likes = [12000, 9999999]; //1
    ...
    settings.likes_by = ['John','AncaD','Sarah','Arjen','Jane','Georgeee','Mary','Heather','Ky','Nick','Lauren'];
  }
  ...
  function get_params() {
    ...
    if(window.QueryString.c !== undefined && !isNaN(parseInt(window.QueryString.c)) && parseInt(window.QueryString.c) >= 0 && parseInt(window.QueryString.c) < 12) {
      window.condition = parseInt(window.QueryString.c);
    } else {
      window.condition = 0; // condition defaults to 1
    }
  ...
  function adjust_to_condition() {
	...
	switch(condition) {
		case 1:
			...
			window.others.posts[0:11].likes = settings.condition_1_adjusted_likes;
			break;
		case 2:
    ...
    case 6:
    	...
    	break;
    case 7:
  		window.settings.condition_likes = settings.condition_7_likes;
  		window.others.posts[1].likes = settings.condition_7_adjusted_likes;
  		break;
    case 8:
  		window.settings.condition_likes = settings.condition_8_likes;
  		window.others.posts[1].likes = settings.condition_8_adjusted_likes;
  		break;
    case 9:
  		window.settings.condition_likes = settings.condition_9_likes;
  		window.others.posts[1].likes = settings.condition_9_adjusted_likes;
  		break;
    case 10:
  		window.settings.condition_likes = settings.condition_10_likes;
  		window.others.posts[1].likes = settings.condition_10_adjusted_likes;
  		break;
    case 11:
  		window.settings.condition_likes = settings.condition_11_likes;
  		window.others.posts[1].likes = settings.condition_11_adjusted_likes;
  		break;
    case 0:
  		window.settings.condition_likes = settings.condition_0_likes;
  		window.others.posts[1].likes = settings.condition_0_adjusted_likes;
  		break;
