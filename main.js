...
$(function() {
  ...
  settings.condition_1_likes = [20000,9999999];
  ...
  settings.condition_2_likes = [15000,55000];
  ...
  settings.condition_3_likes = [10000,45000,85000];
  ...
  settings.condition_4_likes = [3000,21000,40000,95000];
  ...
  settings.condition_5_likes = [13000,11000,15000,25000,70000];
  ...
  settings.condition_6_likes = [4000,17000,20000,35000,80000,100000];
  ...
  settings.condition_7_likes = [2000,15000,18000,25000,60000,100000,103000];
  ...
  settings.condition_8_likes = [6000,13000,17000,35000,70000,90000,100000,105000];
  ...
  settings.condition_9_likes = [4000,8000,15000,30000,50000,80000,85000,95000,110000];
  ...
  settings.condition_10_likes = [1000,14000,23000,35000,40000,55000,60000,75000,84000,100000];
  ...
  settings.condition_11_likes = [5000,11000,27000,38000,45000,57000,61000,71000,89000,95000,107000];
...
// To keep the total distribution of "likes" constant across conditions, The "likes" received by one group member can be adjusted according to the participant's. By default, the other group member receives 9 "likes" in the participant-ostracism condition, 5 in the participant-inclusion condtion, and 1 in the participant-overinclusion condtion.
  settings.condition_0_adjusted_likes = [5000,11000,27000,38000,45000,57000,61000,71000,89000,95000,107000]; //11
  settings.condition_1_adjusted_likes = [1000,14000,23000,35000,40000,55000,60000,75000,84000,100000]; // 10
  settings.condition_2_adjusted_likes = [4000,8000,15000,30000,50000,80000,85000,95000,110000]; // 9
  settings.condition_3_adjusted_likes = [6000,13000,17000,35000,70000,90000,100000,105000]; //8
  settings.condition_4_adjusted_likes = [2000,15000,18000,25000,60000,100000,103000]; //7
  settings.condition_5_adjusted_likes = [4000,17000,20000,35000,80000,100000]; //6
  settings.condition_6_adjusted_likes = [13000,11000,15000,25000,70000]; //5
  settings.condition_7_adjusted_likes = [3000,21000,40000,95000]; //4
  settings.condition_8_adjusted_likes = [10000,45000,85000]; //3
  settings.condition_9_adjusted_likes = [15000,55000]; //2
  settings.condition_10_adjusted_likes = [20000,9999999]; //1
  settings.condition_11_adjusted_likes = [9999900,9999999]; //1
  ...
  function adjust_to_condition() {
	...
	switch(window.condition) {
      ...
      // window.others.posts[0].likes = settings.condition_0_adjusted_likes;
			break;
		case 2:
